...
TEST(UART, StartADCDataDump) {
    ...
    uint8_t cmd[] = { 0x10, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F };
    {
        InSequence s;
        for (int i = 0; i < PACKET_SIZE+1; i++) {
            EXPECT_CALL(uart, read())
    ...
    uint8_t res[] = {
        0x20, 0x70, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x6B,
...
TEST(UART, StopADCDataDump) {
    ...
    uint8_t res[] = {
        ...
        0x30, 0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF1, 0x96,
        0x30, 0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF1, 0x96,
        0x20, 0x71, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x6E
    };
    {
        InSequence s;
